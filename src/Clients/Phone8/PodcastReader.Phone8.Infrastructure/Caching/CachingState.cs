...
namespace PodcastReader.Infrastructure.Caching
{
    public class CachingState : ReactiveObject, ICachingState
    {
        ...
        public CachingState(IPodcastItem item, IBackgroundDownloader downloader)
        {
            ...
            var progresses = Observable.Create<IReactiveProgress<ulong>>(async observer =>
                {
                    ...
                    if (cacheInfo == null || cacheInfo.Downloaded < cacheInfo.FinalSize)
                    {
                        ...
                        _downloader.ForgetAbout(transferUri);
            ...
            _progress = progresses.ToProperty(this, x => x.Progress);
