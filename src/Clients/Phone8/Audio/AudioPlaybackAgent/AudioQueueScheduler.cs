...
namespace Audio.AudioPlaybackAgent
{
    public class AudioQueueScheduler : AudioPlayerAgent
    {
        /// <remarks>
        /// AudioQueueScheduler instances can share the same process.
        /// Static fields can be used to share state between AudioQueueScheduler instances
        /// or to communicate with the Audio Streaming agent.
        /// </remarks>
        static AudioQueueScheduler()
        {
